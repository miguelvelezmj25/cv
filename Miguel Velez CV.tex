...
\address{Carnegie Mellon University}{Institute for Software Research}{5000 Forbes Avenue, Pittsburgh, PA 15213}
\phone[mobile]{+1~(651)~468~8988}
...
\cventry{2015}{Application Developer/Software Engineer}{Sportradar US}{Minneapolis, MN}{USA}
...
\nocite{JVKSK:SEAMS17,VSIC:FiC16}
...
%Data Structures Using Object-Oriented Design
%Computer Applications in Experimental Sciences
...
\cvitem{UST}{Algorithms, Database Design, Artificial Intelligence \& Robotics, Computer Applications in Experimental Sciences.}
\cvitem{CMU}{Software Engineering Research, Applied Machine Learning.}

\section{Other Interests and Activities}
\cvitem{2016}{ICSE 2017 Sub-Reviewer}
