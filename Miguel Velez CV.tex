...
\cventry{2022 - Present}{Software Engineer III}{Google}{Boulder, CO}{USA}
	{Field Tasking team}
...
\subsection{Intern Mentor}

\cvitem{Summer 2022}{Joey Morquecho (Google)}
\cvitem{Summer 2022}{Marcos Acosta (Google)}

\medskip

\subsection{Code Readability}

\cvitem{2022 - Present}{Reviewed over 90 changelists for other teams at Google}
\cvitem{2022 - Present}{Became a Kotlin Readability Mentor - Mentored 1 candidate from start to finish}
