...
\cventry{Summer 2019}{Software Engineering Intern}{Google}{Sunnyvale, CA}{USA}
	{Independently designed and implemented a data federation GraphQL layer in CDAP/Cloud Data Fusion.}
...
\cvitem{2018, 2019}{Hispanic Googler Network}
...
{
    \cvreference{Edwin Elia	}
   	{Cloud Data Fusion}
   	{Google}
   	{}{}
   	{edwinelia [at] google.com}
   	{}
   	{+1 608 320 5404}	
}
